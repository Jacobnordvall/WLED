...
var cfg = {
	...
	comp :{colors:{picker: true, rgb: false, quick: true, hex: false},
		  labels:false, pcmbot:false, pid:true, seglen:false, segpwr:false, segexp:false,
		  css:true, hdays:false, fxdef:true, on:0, off:0, idsort: true}
};
...
${urows}
${urows===""?'':'<tr><td colspan="2"><hr style="height:2px; border-width:0; color:var(--c-6); background-color:var(--c-6);"></td></tr>'}
...
${inforow("MAC address",i.mac)}
${inforow("MAC address", i.mac.replace(/([a-f0-9]{2})(?=[a-f0-9]{2})/g, '$1:'))}
